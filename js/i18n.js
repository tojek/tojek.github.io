...
const translations = {
    ...
    'pl': {
        ...
        'about_p1': 'Jestem malarką przyciąganą przez ciemność, delikatność i przemijanie. Moja twórczość eksploruje gotyckie tematy — żałobę, transformację, mit, cielesność — poprzez warstwowe tekstury i nastrojowe palety.',
        'about_p2': 'Z doświadczeniem w charakteryzacji SFX dla filmu i teatru, przenoszę obsesję na skórę, blizny i subtelne zniekształcenia. Poza planem maluję, szkicuję, rzeźbię i szyję — budując światy, gdzie piękno i ruina splatają się ze sobą.',
        'about_p3': 'Każde dzieło to cicha scena z jakiegoś zapomnianego rytuału lub snu — fragment czegoś świętego i dziwnego.',
